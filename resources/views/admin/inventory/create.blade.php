    ...
    <div class="inventory-shell">
        <div class="inventory-panel">
            <div class="inventory-panel__header">
                ...
                <h1 class="inventory-title">Add vehicle</h1>
                <p class="inventory-copy">Create a clean listing for the storefront and vehicle detail page.</p>
            </div>
            <div class="inventory-panel__body">
                    <form action="{{ route('admin.inventory.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-primary px-5">Save Inventory</button>
                        </div>
                    </form>
            </div>
        </div>
