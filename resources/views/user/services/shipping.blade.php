...
@section('content')
    @include('user.partials.page-hero', [
        ...
        'media' => "linear-gradient(135deg, rgba(5,8,22,0.18), rgba(5,8,22,0.58)), url('https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?auto=format&fit=crop&w=1400&q=80')",
    ])
