        ...
        <div class="mx-auto grid w-full max-w-[1600px] gap-5 px-4 sm:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:px-12 xl:px-16">
            <div class="contact-panel reveal-card" data-reveal>
                <div class="contact-panel__section">
                    ...
                    <p class="contact-panel__copy">4238 Lindley Ln<br>Downers Grove, IL 60515</p>
                </div>

                <div class="contact-panel__section">
                    <p class="contact-panel__eyebrow">Reach Us</p>
                    <p class="contact-panel__copy">Phone: +1 (312) 735-9915<br>Email: info@nitromotorsusa.com</p>
                </div>
